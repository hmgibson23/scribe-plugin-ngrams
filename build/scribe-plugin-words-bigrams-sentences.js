(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.scribePluginWordsBigramsSentences = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
'use strict';
...
},{"xhr2":4}],3:[function(require,module,exports){
...
module.exports = function (config) {
    ...
    return function (scribe) {
        var unWords = [function (text) {
            return text.replace(/the/g, " ");
        }, function (text) {
            return text.replace(/and/g, " ");
        }, function (text) {
            return text.replace(/but/g, " ");
        }, function (text) {
            return text.replace(/then/g, " ");
        }, function (text) {
            return text.replace(/ a /g, " ");
        }, function (text) {
            return text.replace(/ of /g, " ");
        }, function (text) {
            return text.replace(/ an /g, " ");
        }, function (text) {
            return text.replace(/ in /g, " ");
        }, function (text) {
            return text.replace(/ on /g, " ");
        }, function (text) {
            return text.replace(/ by /g, " ");
        }, function (text) {
        ...
        nGramsCommand.execute = function () {
            var text = unWords.reduce(function (val, fn) {
                return fn(val);
            }, scribe.el.innerText);

            var nGrams = wordGrams.buildNGrams(text);
            var list = wordGrams.listAllNGrams(nGrams);
            var mostCommon = wordGrams.getMostCommonNGrams(nGrams);
        ...
        nGramsCommand.queryEnable = function () {
            return true;
        };
...
},{"n-gram":1,"reqwest":2,"word-ngrams":3}]},{},[5])(5)
});